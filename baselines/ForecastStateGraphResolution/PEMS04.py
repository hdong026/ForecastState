...
OPTIMIZATION_MODE = "gradient_projection"  # final_only | weighted_sum | gradient_projection
INITIAL_FORECAST = "kasa"  # zero | last_value | linear_head | kasa
USE_GRAPH = True
...
CFG = EasyDict()
CFG.DESCRIPTION = "ForecastStateGraphResolution on PEMS04 12->12"
CFG.GPU_NUM = 1
