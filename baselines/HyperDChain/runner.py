"""Runner for HyperD Forecast-State Chain with scale-matched loss + DVA."""
    ...
    def forward(
        ...
        **kwargs,
        ...
        model_return = {
            ...
            # Keep DVA in the BasicTS return for val/test
            # loss aggregation (same pattern as HyperD).
            "dual_view_loss": out["dual_view_loss"],
        }
